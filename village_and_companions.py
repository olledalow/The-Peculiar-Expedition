...
# }
#
# vendor = {  # contains the traders merchandise in the village
#     "fruit": [5, 45, 15],
#     "meat": [5, 60, 25],
#     "chocolate": [5, 50, 20],
#     "medicine": [5, 50, 20],
...
#
#
# def f(current_gold, current_energy, current_vendor, current_companions, current_inventory, def_slot, scout_sight):
#     # Village: chance to recruit villagers as companions, sell and buy items at vendor, rest for restoring energy
#
#     while True:
#
#         display_village()
#         z = input("For trading enter 'trade', for resting 'rest', for hiring 'hire'"
#                   " or hit 'ENTER' to leave the village ").lower()
#         if z == "trade":
#             display_merchant()
#
...
#
#
# def villager_recruitment(current_gold, current_companions, current_inventory, scout_sight):
